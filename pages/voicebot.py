...
with col_right:
    ...
    st.markdown(f"""
    <div class="transcript-container" style="padding:1rem; background-color:#f5f6fa; border-radius:12px; margin-bottom:1rem;">
      ...
      <div class="transcript-text" style="margin-top:0.5rem;">{clean_transcript}</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown(f"""
    <div class="response-container" style="padding:1rem; background-color:#f5f6fa; border-radius:12px;">
      <div class="panel-header" style="display:flex;align-items:center;justify-content:space-between;">
        <div style="display:flex;align-items:center;gap:0.5rem;">
