...
with col_right:
    ...
    <div class="transcript-container">
      <div class="panel-header">
        <img src="C:/Hajj/static/talbiyah.png" class="panel-icon {transcript_icon_class}" width="24" height="24" style="object-fit: contain; margin-right: 0.5rem;">
    ...
    <div class="response-container" style="margin-top:1rem;">
      <div class="panel-header">
        <img src="C:/Hajj/static/talbiyah.png" class="panel-icon {response_icon_class}" width="24" height="24" style="object-fit: contain; margin-right: 0.5rem;">
